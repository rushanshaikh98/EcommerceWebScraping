...
logger = setup_logger('farfetch_scraper info logger', 'logs/selenium/farfetch.log')


def farfetch_scraper(url: str):
    ...
    BRAND_SELECTOR_PATH = "a.ltr-jtdb6u-Body-Heading-HeadingBold"
    NAME_SELECTOR_PATH = "p.ltr-13ze6d5-Body"
    PRICE_SELECTOR_PATH = "p[data-component='PriceLarge']"
    IMAGES_SELECTOR_PATH = "div.ltr-bjn8wh img"
