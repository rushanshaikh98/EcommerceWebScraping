...
logger = setup_logger('real_scraper info logger', 'logs/selenium/real.log')


def real_scraper(url: str):
    ...
    BRAND_SELECTOR_PATH = "div.brand a"
    NAME_SELECTOR_PATH = "div.product-name"
    PRICE_SELECTOR_PATH = "div.product-price"
    IMAGES_SELECTOR_PATH = "div.pdp-desktop-images div.main-image img"
    ...
    absolute_image_src = [image.get_attribute('data-srcset').split()[-2] for image in images]
